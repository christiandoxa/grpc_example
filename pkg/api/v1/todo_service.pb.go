...
type ToDo struct {
	...
	// Unique integer identifier of the to do task
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	// Title of the task
	Title string `protobuf:"bytes,2,opt,name=title,proto3" json:"title,omitempty"`
	// Detail description of the to do task
	Description string `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
	// Date and time to remind the to do task
...
// Request data to create new to do task
...
// Contains data of created to do task
...
// Request data to read to do task
...
// Contains to do task data specified in by ID request
...
// Request data to update to do task
...
// Request data to delete to do task
type DeleteRequest struct {
	...
	// API versioning: it is my best practice to specify version explicitly
	Api string `protobuf:"bytes,1,opt,name=api,proto3" json:"api,omitempty"`
	// Unique integer identifier of the to do task to delete
	Id int64 `protobuf:"varint,2,opt,name=id,proto3" json:"id,omitempty"`
}
...
// Request data to read all to do task
...
// Contains list of all to do tasks
...
var file_todo_service_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0xbf, 0x02, 0x0a, 0x0b, 0x54, 0x6f, 0x44, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x6e, 0x73, 0x65, 0x12, 0x3e, 0x0a, 0x11, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x43, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x64, 0x54, 0x6f, 0x64, 0x6f, 0x12, 0x12, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65,
	...
	0x65, 0x30, 0x01, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_todo_service_proto_depIdxs = []int32{
	...
	9,  // 10: v1.ToDoService.StreamChangedTodo:input_type -> v1.ReadAllRequest
	...
	10, // 16: v1.ToDoService.StreamChangedTodo:output_type -> v1.ReadAllResponse
